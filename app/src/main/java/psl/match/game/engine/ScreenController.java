...
import psl.match.game.fragments.DifficultySelectFragment;
import psl.match.game.fragments.GameFragment;
import psl.match.game.fragments.MenuFragment;
import psl.match.game.fragments.ThemeSelectFragment;
...
public class ScreenController {
	...
	public void openScreen(Screen screen) {
		try {
			...
			Toast.makeText(Shared.context, "Unable to open screen", Toast.LENGTH_SHORT).show();
		}
	}
