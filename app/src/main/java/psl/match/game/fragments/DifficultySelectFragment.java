...
import psl.match.game.ui.DifficultyView;

public class DifficultySelectFragment extends Fragment {
    private AdView themeSelectionAdView,themeSelectionAdView2,themeSelectionAdView3,themeSelectionAdView4;
    @Override
...
//          Toast.makeText(Shared.context, "Could not load prop screen", Toast.LENGTH_SHORT).show();
      }
        return view;
